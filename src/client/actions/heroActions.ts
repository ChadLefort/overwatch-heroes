...
import { actionCreators as heroesActionCreators } from './heroesActions';
...
export const actionCreators = {
  ...
  fetchHero: (id: string): ThunkAction<Promise<void>, RootState, null> => async dispatch => {
  ...
  updateHero: (hero: Hero): ThunkAction<Promise<AxiosResponse>, RootState, null> => async dispatch => {
    const data = {
      id: hero.id,
    ...
    dispatch(heroesActionCreators.updateHeroes(hero));
